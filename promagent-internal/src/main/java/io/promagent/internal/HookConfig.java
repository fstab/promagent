 ...
 * <p/>
 * The configuration is created from analyzing the hook classes' byte code.
 */
public class HookConfig {

    public static class ClassOrInterfaceConfig implements Comparable<ClassOrInterfaceConfig> {
        ...
        public Set<MethodConfig> getInstrumentedMethods() {
    ...
    public static class MethodConfig implements Comparable<MethodConfig> {
    ...
    public static class Builder {
        ...
        private final List<Path> hookJars;

        private Builder(List<Path> hookJars) {
            this.hookJars = hookJars;
        }
         ...
         */
        public HookConfig parse(String... hookClassNames) throws ClassNotFoundException {
        ...
        private InputStream getResourceAsStream(String name) throws IOException {
            for (Path hookJar : hookJars) {
                try {
                    URL url;
                    if (Files.isDirectory(hookJar)) { // For tests also enable a directory with class files instead of a JAR
    ...
    public static Builder from(List<Path> jarFilesOrClassesDirs) {
        return new Builder(jarFilesOrClassesDirs);
    }

    public Set<ClassOrInterfaceConfig> getInstrumentedClassesOrInterfaces() {
